...
Source File: https://github.com/CatoGit/Comparing-the-Performance-of-Deepfake-Detection-Methods-on-Benchmark-Datasets/blob/master/deepfake_detector/metrics.py
Modified By: Sharvil Vijagish Mainkar
